											...
											<tr>
												...
												<th colspan="5">
													...
													<button id="btnSave" type="button"
														...
														onclick="createjson()">Save & Next</button>
												</th>
...
<div class="modal fade" id="MMM" role="dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="modal-footer">
							...
							<a type="button" class="btn btn-default" href="AddPublisher?campaignId=${campaignId}">Continue With Default Order</a>
						</div>
				</div>
			</div>
			</div>
	...
	<script>
		...
		function GetDynamicTextBox(value) {
			return '<td><input id="answer" onchange="validate()" onkeydown="validate()" name = "answer" type="text" placeholder = "Answer" class="form-control" /></td>'
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (count > 0) { 
						...
						window.location.href = '${context}/updateCampaignQuestion?questionId='+quesId+'&campaignId='+campId+'&size='+count
